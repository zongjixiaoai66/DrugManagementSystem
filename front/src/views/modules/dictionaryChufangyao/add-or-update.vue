<template>
    <div class="addEdit-block">
        ...
        >
            <el-row>
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'"  label="处方药编码" prop="codeIndex">
                        <el-input v-model="ruleForm.codeIndex"
                                  placeholder="处方药编码" clearable  :readonly="ro.codeIndex"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="处方药编码" prop="codeIndex">
                            <el-input v-model="ruleForm.codeIndex"
                                      placeholder="处方药编码" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'"  label="处方药" prop="indexName">
                        <el-input v-model="ruleForm.indexName"
                                  placeholder="处方药" clearable  :readonly="ro.indexName"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="处方药" prop="indexName">
                            <el-input v-model="ruleForm.indexName"
        ...
        methods: {
            ...
            onSubmit() {
                if((!this.ruleForm.indexName)){
                    this.$message.error('处方药不能为空');
                    return
                }
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        let ruleForm = this.ruleForm;
                        ruleForm["dicCode"]="chufangyao_types";
                        ruleForm["dicName"]="处方药";
                        this.$http({
