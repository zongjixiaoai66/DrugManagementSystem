        ...
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.yaopinOrderFile" label="医生证明" prop="yaopinOrderFile">
                        <file-upload
                                tip="点击上传医生证明"
                                action="file/upload"
                                :limit="3"
                                :multiple="true"
                                :fileUrls="ruleForm.yaopinOrderFile?$base.url+ruleForm.yaopinOrderFile:''"
                                @change="yaopinOrderFileUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.yaopinOrderFile" label="医生证明" prop="yaopinOrderFile">
                            <a type="text" style="text-decoration:none" class="el-button" :href="$base.url+ruleForm.yaopinOrderFile"  >医生证明下载</a>
                        </el-form-item>
                    </div>
                </el-col>
               <el-col :span="12">
            ...
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.yaopinOrderYesnoTypes" label="审核状态" prop="yaopinOrderYesnoTypes">
                        <el-input v-model="ruleForm.yaopinOrderYesnoValue" placeholder="审核状态" readonly></el-input>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.yaopinOrderYesnoText" label="审核意见" prop="yaopinOrderYesnoText">
                        <span v-html="ruleForm.yaopinOrderYesnoText"></span>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.yaopinOrderShenheTime" label="审核时间" prop="yaopinOrderShenheTime">
                        <span v-html="ruleForm.yaopinOrderShenheTime"></span>
                    </el-form-item>
                </div>
            </el-col>
                <el-col :span="12">
    ...
    export default {
        data() {
            return {
                ...
                yonghuForm: {},
                ro:{
                    yaopinOrderUuidNumber: true,
                    addressId: false,
                    yaopinId: false,
                    yonghuId: false,
                    buyNumber: false,
                    yaopinOrderFile: false,
                    yaopinOrderTruePrice: false,
                    yaopinOrderCourierName: false,
                    yaopinOrderCourierNumber: false,
                    yaopinOrderTypes: false,
                    yaopinOrderYesnoTypes: false,
                    yaopinOrderYesnoText: false,
                    yaopinOrderShenheTime: false,
                ...
                ruleForm: {
                    ...
                    yaopinOrderTypes: '',
                    yaopinOrderYesnoTypes: '',
                    yaopinOrderYesnoText: '',
                    yaopinOrderShenheTime: '',
                    yaopinOrderPaymentTypes: '',
                    insertTime: '',
                },
                yaopinOrderTypesOptions : [],
                yaopinOrderYesnoTypesOptions : [],
                ...
                rules: {
                   ...
                   yaopinOrderFile: [
                              { required: true, message: '医生证明不能为空', trigger: 'blur' },
                          ],
                   yaopinOrderTruePrice: [
        ...
        created() {
            ...
            //获取下拉框信息
                ...
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=yaopin_order_yesno_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.yaopinOrderYesnoTypesOptions = data.data.list;
                    }
                });
                this.$http({
        ...
        methods: {
            ...
            //图片
            yaopinOrderFileUploadChange(fileUrls){
                this.ruleForm.yaopinOrderFile = fileUrls;
                this.addEditUploadStyleChange()
            },
