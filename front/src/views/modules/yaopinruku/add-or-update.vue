    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='yaopin' ">
                    <el-form-item class="input" v-if="type!='info'"  label="处方药" prop="chufangyaoValue">
                        <el-input v-model="yaopinForm.chufangyaoValue"
                                  placeholder="处方药" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                ...
                <el-col :span="12"  v-if="sessionTable !='yaopin' ">
                    <el-form-item class="input" v-if="type!='info'"  label="二级类型" prop="yaopinErjiValue">
                        <el-input v-model="yaopinForm.yaopinErjiValue"
            ...
            <input id="yuangongId" name="yuangongId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="药品入库编号" prop="yaopinrukuUuidNumber">
                       <el-input v-model="ruleForm.yaopinrukuUuidNumber"
                                 placeholder="药品入库编号" clearable  :readonly="ro.yaopinrukuUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="药品入库编号" prop="yaopinrukuUuidNumber">
                           <el-input v-model="ruleForm.yaopinrukuUuidNumber"
                                     placeholder="药品入库编号" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="入库标题" prop="yaopinrukuName">
                       <el-input v-model="ruleForm.yaopinrukuName"
                                 placeholder="入库标题" clearable  :readonly="ro.yaopinrukuName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="入库标题" prop="yaopinrukuName">
                           <el-input v-model="ruleForm.yaopinrukuName"
                                     placeholder="入库标题" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="药品入库类型" prop="yaopinrukuTypes">
                        <el-select v-model="ruleForm.yaopinrukuTypes" :disabled="ro.yaopinrukuTypes" placeholder="请选择药品入库类型">
                            <el-option
                                v-for="(item,index) in yaopinrukuTypesOptions"
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="药品入库类型" prop="yaopinrukuValue">
                        <el-input v-model="ruleForm.yaopinrukuValue"
                            placeholder="药品入库类型" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.yaopinrukuFile" label="附件" prop="yaopinrukuFile">
                        <file-upload
                                tip="点击上传附件"
                                action="file/upload"
                                :limit="3"
                                :multiple="true"
                                :fileUrls="ruleForm.yaopinrukuFile?$base.url+ruleForm.yaopinrukuFile:''"
                                @change="yaopinrukuFileUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.yaopinrukuFile" label="附件" prop="yaopinrukuFile">
                            <a type="text" style="text-decoration:none" class="el-button" :href="$base.url+ruleForm.yaopinrukuFile"  >附件下载</a>
                        </el-form-item>
                    </div>
                </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="入库数量" prop="yaopinrukuNumber">
                       <el-input v-model="ruleForm.yaopinrukuNumber"
                                 placeholder="入库数量" clearable  :readonly="ro.yaopinrukuNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="入库数量" prop="yaopinrukuNumber">
                           <el-input v-model="ruleForm.yaopinrukuNumber"
                ...
                <el-col :span="12">
                    <el-form-item v-if="type!='info' && !ro.yaopinrukuTime"  class="input" label="入库时间" prop="yaopinrukuTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                                v-model="ruleForm.yaopinrukuTime"
                                type="datetime"
                                placeholder="入库时间"
                                :disabled="ro.yaopinrukuTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.yaopinrukuTime" label="入库时间" prop="yaopinrukuTime">
                            <span v-html="ruleForm.yaopinrukuTime"></span>
                        </el-form-item>
                    </div>
                </el-col>

                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.yaopinrukuContent"  label="入库缘由" prop="yaopinrukuContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.yaopinrukuContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.yaopinrukuContent" label="入库缘由" prop="yaopinrukuContent">
                            <span v-html="ruleForm.yaopinrukuContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                ruleForm: {
                    yaopinId: '',
                    yuangongId: '',
                    yaopinrukuUuidNumber: new Date().getTime(),
                    yaopinrukuName: '',
                    yaopinrukuTypes: '',
                    yaopinrukuFile: '',
                    yaopinrukuNumber: '',
                ...
                rules: {
                   ...
                   yaopinrukuUuidNumber: [
                              { required: true, message: '药品入库编号不能为空', trigger: 'blur' },
                          ],
                   yaopinrukuName: [
                              { required: true, message: '入库标题不能为空', trigger: 'blur' },
                          ],
                   yaopinrukuTypes: [
                              { required: true, message: '药品入库类型不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   yaopinrukuContent: [
                              { required: true, message: '入库缘由不能为空', trigger: 'blur' },
                          ],
                   insertTime: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=yaopinruku_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.yaopinrukuTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            info(id) {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        _this.ruleForm.yaopinrukuContent = _this.ruleForm.yaopinrukuContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                    } else {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.ruleForm.yaopinrukuContent = this.ruleForm.yaopinrukuContent.replaceAll(this.$base.url,"");
                        this.$http({
            ...
            //图片
            yaopinrukuFileUploadChange(fileUrls){
                this.ruleForm.yaopinrukuFile = fileUrls;
                this.addEditUploadStyleChange()
            },
