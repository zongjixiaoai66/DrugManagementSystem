...
//        else if("用户".equals(role))
//            yaopinCommentback.setYonghuId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
        if("".equals(yaopinCommentback.getYaopinCommentbackText()) || "null".equals(yaopinCommentback.getYaopinCommentbackText())){
                yaopinCommentback.setYaopinCommentbackText(null);
        }
        if("".equals(yaopinCommentback.getReplyText()) || "null".equals(yaopinCommentback.getReplyText())){
                yaopinCommentback.setReplyText(null);
        }
