...
public class YaopinOrderEntity<T> implements Serializable {
     ...
     * 医生证明
     */
    @ColumnInfo(comment="医生证明",type="varchar(200)")
    @TableField(value = "yaopin_order_file")

    private String yaopinOrderFile;
    ...
    @TableField(value = "yaopin_order_yesno_types")

    private Integer yaopinOrderYesnoTypes;
    ...
    @TableField(value = "yaopin_order_yesno_text")

    private String yaopinOrderYesnoText;
    ...
    @TableField(value = "yaopin_order_shenhe_time")

    private Date yaopinOrderShenheTime;
    ...
    @JsonFormat(locale="zh", timezone="GMT+8", pattern="yyyy-MM-dd HH:mm:ss")
	@DateTimeFormat
    @ColumnInfo(comment="购买时间",type="timestamp")
	 ...
	 * 获取：医生证明
	 */
    public String getYaopinOrderFile() {
        return yaopinOrderFile;
    }
    /**
	 * 设置：医生证明
	 */

    public void setYaopinOrderFile(String yaopinOrderFile) {
        this.yaopinOrderFile = yaopinOrderFile;
    }
    /**
	 * 获取：实付价格
	 */
	 ...
	 * 获取：审核状态
	 */
    public Integer getYaopinOrderYesnoTypes() {
        return yaopinOrderYesnoTypes;
    }
    /**
	 * 设置：审核状态
	 */

    public void setYaopinOrderYesnoTypes(Integer yaopinOrderYesnoTypes) {
        this.yaopinOrderYesnoTypes = yaopinOrderYesnoTypes;
    }
    /**
	 * 获取：审核意见
	 */
    public String getYaopinOrderYesnoText() {
        return yaopinOrderYesnoText;
    }
    /**
	 * 设置：审核意见
	 */

    public void setYaopinOrderYesnoText(String yaopinOrderYesnoText) {
        this.yaopinOrderYesnoText = yaopinOrderYesnoText;
    }
    /**
	 * 获取：审核时间
	 */
    public Date getYaopinOrderShenheTime() {
        return yaopinOrderShenheTime;
    }
    /**
	 * 设置：审核时间
	 */

    public void setYaopinOrderShenheTime(Date yaopinOrderShenheTime) {
        this.yaopinOrderShenheTime = yaopinOrderShenheTime;
    }
    /**
	 * 获取：支付类型
	 */
    ...
    public String toString() {
        return "YaopinOrder{" +
            ...
            ", yonghuId=" + yonghuId +
            ", buyNumber=" + buyNumber +
            ", yaopinOrderFile=" + yaopinOrderFile +
            ...
            ", yaopinOrderYesnoTypes=" + yaopinOrderYesnoTypes +
            ", yaopinOrderYesnoText=" + yaopinOrderYesnoText +
            ", yaopinOrderShenheTime=" + DateUtil.convertString(yaopinOrderShenheTime,"yyyy-MM-dd") +
